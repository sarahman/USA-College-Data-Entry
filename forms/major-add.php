...
<form action="" method="POST" id='major-add-form'>
    ...
    <fieldset>
        ...
        <?php echo getFormError($errorMessage, 'collegeMajorError') ?>
        ...
        <p>
            ...
            <?php echo getErrorMessage($errorMessage, 'college_id') ?>
        </p>
        <p>
            ...
            <span class="stars">*</span>
            <?php echo getErrorMessage($errorMessage, 'subject_name') ?>
        </p>
